...
let linkStyle = Style {
    ...
    if #available(iOS 13.0, *) {
        ...
        $0.color = UIColor.blue// Fallback on earlier versions
    }
}
...
let titleStyle = Style {
    ...
    if #available(iOS 13.0, *) {
        ...
        $0.color = UIColor.black// Fallback on earlier versions
    }
}
let boldStyle = Style {
    $0.font = UIFont.boldSystemFont(ofSize: CGFloat(DataManager.instance.fontSize))
...
class DataManager
{
    ...
    private init()
    {
        ...
        publicDevice = defaults.bool(forKey: "public_device")
    }
    ...
    func documentByKey(key : String) -> Document?
    {
        ...
        print("Could not find document for key", key)
        return nil
    }
