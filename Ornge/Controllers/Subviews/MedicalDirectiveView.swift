...
let acplColor = UIColor(hex: "#fcba03ff")
...
class MedicalDirectiveView : UIView
{
    ...
    func initSubviews() {
        ...
        if #available(iOS 13.0, *) {
            ...
            treatmentView.layer.borderColor = UIColor(named: "Border_color")?.cgColor
        }
    ...
    func initDrugCard(_ directive : TreatmentCard) {
        ...
        titleStack.addBackground(color: backgroundColor, outlineColor: UIColor(named: "Border_color")! )
        ...
        treatmentView.backgroundColor = UIColor(named: "Secondary_background")
        ...
        NSLayoutConstraint.activate([locPatchStack.heightAnchor.constraint(greaterThanOrEqualToConstant: CGFloat(levelOfCare.count) * 120)])
            for locVersion in levelOfCare {
                ...
                patchPointButton.layer.borderColor = UIColor(named: "Border_color")!.cgColor

                locButton.layer.borderWidth = 0.5
                locButton.layer.borderColor = UIColor(named: "Border_color")!.cgColor
            }
        } else {
        ...
        for y in 0 ..< doseRoute.count {
            ...
            for x in 0 ..< doseRoute[y].count {
                ...
                labelView.layer.borderColor = UIColor(named: "Border_color")!.cgColor
